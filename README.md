...
The first code has been created with a fully working RBAC security solution and form authentication that allows you to login based on users in the database and their roles. It also has language and session support via encrypted cookie. It is just the rest of the applciation now ;-)
